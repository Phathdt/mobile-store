      ...
      return (
        <div>
              <div style={horizontalJustifyContent} className="footerLink">
                ...
                <div> 
                    <ul>
                        <li><a href="/tos" title="Quy chế hoạt động">Quy chế hoạt động</a></li>
                        <li><a href="/noi-quy-cua-hang" title="Nội quy cửa hàng">Nội quy cửa hàng</a></li>
                        <li><a href="/chat-luong-phuc-vu" title="Chất lượng phục vụ">Chất lượng phục vụ</a></li>
                        <li><a href="/trao-thuong" title="Thông tin trao thưởng">Thông tin trao thưởng</a></li>
                    </ul>
                </div>
                <div> 
                    <ul>
