    ...
    constructor(props) {
      ...
      async componentWillMount() {
        if(brands.indexOf(this.props.match.params.brandName)!==-1){
          ...
          var brandData=[]
          response.map(i=>(
              brandData=brandData.concat(i.content)
          ))
      ...
      getVariantByBrand = async id => {
        ...
        try {
          ...
          if (res.status === 401) {
            ...
            var results = await Promise.all(resJson.data.content.map(async i => {
        ...
        <div className="centerContent">
          <div className="row">
            ...
            <div className="col-lg-9">
              <h2 className="brand-title">All products  >  Model: {this.state.id}</h2>
              <div className="row">
